...
describe('Validate JS configs', () => {
  it('Validate eslint-config-cyril', async () => {
  ...
  it('Validate eslint-config-cyril/es5', async () => {
  ...
  it('Validate eslint-config-cyril/vue', async () => {
  ...
  it('Validate eslint-config-cyril/essential', async () => {
  ...
  it('Validate eslint-config-cyril/essential/es5', async () => {
  ...
  it('Validate eslint-config-cyril/essential/react', async () => {
  ...
  it('Validate eslint-config-cyril/essential/vue', async () => {
  ...
  it('Validate eslint-config-cyril/node', async () => {
