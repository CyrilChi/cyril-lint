...
describe('Validate TS configs', () => {
  it('Validate eslint-config-cyril/typescript', async () => {
  ...
  it('Validate eslint-config-cyril/typescript/vue', async () => {
  ...
  it('Validate eslint-config-cyril/essential/typescript', async () => {
  ...
  it('Validate eslint-config-cyril/essential/typescript/react', async () => {
  ...
  it('Validate eslint-config-cyril/essential/typescript/vue', async () => {
  ...
  it('Validate eslint-config-cyril/typescript/node', async () => {
